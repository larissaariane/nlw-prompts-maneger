...
const elements = {
  ...
  btnCopie: document.getElementById("btn-copy"),
}
...
function openSidebar() {
  ...
  elements.sidebar.classList.remove("collapse")
}

// Função para fechar a sidebar
function closeSidebar() {
  elements.sidebar.classList.remove("open")
  elements.sidebar.classList.add("collapse")
}

// Adiciona os ouvintes de evento para abrir e fechar a sidebar
...
elements.btnCopie.addEventListener("click", copySelected)
